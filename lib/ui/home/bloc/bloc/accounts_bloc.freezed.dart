...
mixin _$AccountsState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Cuentas> listAccounts) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Cuentas> listAccounts)? loaded,
...
abstract class _$$_LoadedCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Cuentas> listAccounts});
}
...
class _$_Loaded implements _Loaded {
  const _$_Loaded(final List<Cuentas> listAccounts)
      : _listAccounts = listAccounts;

  final List<Cuentas> _listAccounts;
  @override
  List<Cuentas> get listAccounts {
    if (_listAccounts is EqualUnmodifiableListView) return _listAccounts;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_listAccounts);
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._listAccounts, _listAccounts));
  }

  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_listAccounts));
...
abstract class _Loaded implements AccountsState {
  const factory _Loaded(final List<Cuentas> listAccounts) = _$_Loaded;
