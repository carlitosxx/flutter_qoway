...
@immutable
class QowayTheme extends ThemeExtension<QowayTheme> {
  const QowayTheme({
  ...
  @override
  ThemeExtension<QowayTheme> copyWith({
    Color? primaryColor,
    Color? tertiaryColor,
    Color? neutralColor,
  }) =>
  ...
  @override
  ThemeExtension<QowayTheme> lerp(
    covariant ThemeExtension<QowayTheme>? other,
    double t,
  ) {
    if (other is! QowayTheme) return this;
    return QowayTheme(
